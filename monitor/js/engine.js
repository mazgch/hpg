...
/*
    ...
    protocol  UBX,NMEA,RTCM3,AT,TEXT,...  				yes      yes      yes
...
function charDump(by) {
    ...
    return charDumpFixed(by);
}

function charDumpFixed(by) {
...
const mapMsg = {
    ...
    0x02/*RXM*/: { 0x13:'SFRBX',     0x14:'MEASX',     0x15:'RAWX',      0x20:'SVSI',      0x32:'RTCM',
                   0x34:'COR',       0x41:'PMREQ',     0x61:'IMES',      0x59:'RLM', },
...
const protocols = [ ProtocolUBX, ProtocolNMEA, ProtocolRTCM3, ProtocolAT, ProtocolTEXT, /*UNKNOWN, DEBUG, TRACE */ ];
