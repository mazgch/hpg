...
export const FieldsReg = Object.freeze( {
    ...
    ewErr      : new Field( 'East/West reference offset',              { unit:'m',       prec:3 } ),
    atErr      : new Field( 'Along track reference offset',            { unit:'m',       prec:3 } ),
    xtErr      : new Field( 'Cross track reference offset',            { unit:'m',       prec:3 } ),
    mslErr     : new Field( 'Mean sea level reference offset',         { unit:'m',       prec:3 } ),
